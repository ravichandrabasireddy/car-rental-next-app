...
type SignUpAdminCardProps = {
    setSignInFlow: React.Dispatch<React.SetStateAction<signInFlow>>;
  };
  
export default function SignUpAdminCard({ setSignInFlow }: SignUpAdminCardProps) {
    ...
    const handlePasswordSignUp = async (e: FormEvent) => {
      ...
      return (
        <div>
          <Card className="mx-auto max-w-[420px] border-none shadow-none">
            <CardHeader>
              <CardTitle className="text-2xl">Sign Up</CardTitle>
              <CardDescription>Enter your email below to sign up as an admin</CardDescription>
            </CardHeader>
            {!!error && (
